...
it lists all the branches, with a star to the current branch
### * feature/uppercase
###   master
7. What is the output of `git log --oneline --graph --all`
### it lists all the commits in one line 
### * bac9269 (HEAD -> feature/uppercase) convert to upper
### * 94f1a49 (master) Add content to greeting.txt
### * 034b75e Add file greeting.txt
